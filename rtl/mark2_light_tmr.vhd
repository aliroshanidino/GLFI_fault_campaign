...
-- Module: Lightweight TMR Homeostatic Neuron (Model 3 - Control-Plane TMR)
...
architecture Behavioral of light_tmr_neuron2 is
    ...
    -- Voted Theta for Datapath calculations
    signal voted_theta : signed(WIDTH-1 downto 0);
    ...
    -- Synthesis Attributes to protect TMR from being optimized away
...
begin
    ...
    -- ------------------------------------------------------------------------
    -- TRIPLICATED CONTROL-PLANE (The Heart of Fault Tolerance)
    -- ------------------------------------------------------------------------
    -- 1. Clamp Flags TMR
    ...
    -- Simplex brake magnitude calculation (protected by voted flag)
    ...
    -- 4. Spike Flag TMR (The Ultimate Valve)
